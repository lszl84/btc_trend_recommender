        ...
        if long_position:
            ...
            if last_tick['low'] <= current_stop:
                ...
                result = position_size * sell_price * \
                    ...
                    (1.0 + fee) - position_size * funding_fee

                capital_usdt += result
                msg = f' * CLOSED long position (${buy_price:.3f}) at ${sell_price:.3f} for PnL={result:.3f}. Capital = ${capital_usdt:.3f}'
            else:
                print(
            ...
            if last_tick['high'] >= current_stop:
                ...
                msg = f' * CLOSED short position (${sell_price:.3f}) at ${buy_price:.3f} for PnL={result:.3f}. Capital = ${capital_usdt:.3f}'
            else:
                print(
